...
/**
 * Lucide-style SVG icons for problem domains
 * No emojis — proper SVG icons per ui-ux-pro-max guidelines
 */

const icons: Record<string, React.FC<{ className?: string }>> = {
  brain: ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2a5 5 0 0 1 4.9 4 4.5 4.5 0 0 1 2.1 3.5A4.5 4.5 0 0 1 17 14a5 5 0 0 1-5 5 5 5 0 0 1-5-5 4.5 4.5 0 0 1-2-4.5A4.5 4.5 0 0 1 7.1 6 5 5 0 0 1 12 2z" />
      <path d="M12 2v17" />
      <path d="M8 8h8" />
      <path d="M9 12h6" />
    </svg>
  ...
  network: ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M12 7v4m-5.2 4.8L11 13m7.2 2.8L13 13" />
  ...
  'file-text': ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z" /><path d="M14 2v4a2 2 0 0 0 2 2h4" /><path d="M10 13H8M16 17H8M12 9H8" />
    </svg>
  ),
  terminal: ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function DomainIcon({ name, className = 'w-6 h-6', color }: DomainIconProps) {
